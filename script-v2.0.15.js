...
if(300 <= tjmPortageo && tjmPortageo < 320){
...
if(300 <= tjmPortup & tjmPortup < 320){
...
if(300 <= tjmCegelem && tjmCegelem < 320){
...
if(300 <= tjmLabelVie && tjmLabelVie < 320){
...
if (fraisGestionBePortage == 5){
    if(300 <= tjmBePortage && tjmBePortage < 320){
...
if(fraisGestionDidaxis = 5){
    if(300 <= tjmDidaxis && tjmDidaxis < 320){
...
if(300 <= tjmKingurley && tjmKingurley < 320){
...
if(300 <= tjmAdmission && tjmAdmission < 320){
...
if(fraisGestionEPPortage=3){
    if(300 <= tjmEPPortage && tjmEPPortage < 320){
...
if(300 <= tjmRHSolutions && tjmRHSolutions < 320){
    caPourcentRHSolutions = 51,76;
}
else if(320 <= tjmRHSolutions && tjmRHSolutio < 340){
    caPourcentRHSolutions = 51,59;
}
else if(340 <= tjmRHSolutions && tjmRHSolutio < 360){
    caPourcentRHSolutions = 51,44;
}
else if(360 <= tjmRHSolutions && tjmRHSolutio < 380){
    caPourcentRHSolutions = 51,30;
}
else if(380 <= tjmRHSolutions && tjmRHSolutio < 400){
    caPourcentRHSolutions = 51,18;
}
else if(400 <= tjmRHSolutions && tjmRHSolutio < 420){
    caPourcentRHSolutions = 51,06;
}
else if(420 <= tjmRHSolutions && tjmRHSolutio < 440){
    caPourcentRHSolutions = 51,51;
}
else if(440 <= tjmRHSolutions && tjmRHSolutio < 460){
    caPourcentRHSolutions = 51,42;
}
else if(460 <= tjmRHSolutions && tjmRHSolutio < 480){
    caPourcentRHSolutions = 51,34;
}
else if(480 <= tjmRHSolutions && tjmRHSolutio < 500){
    caPourcentRHSolutions = 51,26;
}
else if(500 <= tjmRHSolutions && tjmRHSolutio < 520){
    caPourcentRHSolutions = 51,19;
}
else if(520 <= tjmRHSolutions && tjmRHSolutio < 540){
    caPourcentRHSolutions = 51,13;
}
else if(540 <= tjmRHSolutions && tjmRHSolutio < 560){
    caPourcentRHSolutions = 51,07;
}
else if(560 <= tjmRHSolutions && tjmRHSolutio < 580){
    caPourcentRHSolutions = 51,01;
}
else if(580 <= tjmRHSolutions && tjmRHSolutio < 600){
    caPourcentRHSolutions = 50,96;
}
else if(600 <= tjmRHSolutions && tjmRHSolutio < 620){
    caPourcentRHSolutions = 50,91;
}
else if(620 <= tjmRHSolutions && tjmRHSolutio < 640){
    caPourcentRHSolutions = 50,87;
}
else if(640 <= tjmRHSolutions && tjmRHSolutio < 660){
    caPourcentRHSolutions = 50,83;
}
else if(660 <= tjmRHSolutions && tjmRHSolutio < 680){
    caPourcentRHSolutions = 50,79;
}
else if(680 <= tjmRHSolutions && tjmRHSolutio < 700){
...
if(300 <= tjmFreecadre && tjmFreecadre < 320){
...
if(300 <= tjmTalentFactory && tjmTalentFactory < 320){
...
if(300 <= tjmUmalis && tjmUmalis < 320){
...
if(300 <= tjmHighteckers && tjmHighteckers < 320){
...
//
if(300 <= tjmABCPortage && tjmABCPortage< 320){
